...
// System.String documentation for details.
            ...
            string msg1 = "hello\0";  //с символом null
            string msg2 = "hello";
            ...
            Console.WriteLine(msg1[0]);  //индексное обращение к нулевому символу в строке
            ...
            Console.WriteLine(s11.GetHashCode());   //посмотреть по хэшкоду изменилась ли строка, если хэшкод отличается - строка изменилась
            //string s31 = s11 + " " + s21;   //объединене строк
            s11 += s21;
            Console.WriteLine(s11);
            //Console.WriteLine(s31);
            string s31 = string.Concat(s11, s21, "110", "!!!");   //объединение строк
            ...
            string str_final = string.Join(" : ", values);  //формироване новой строки из множества через сипаратор (разделитель)
