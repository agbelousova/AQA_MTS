public class Corporate : Client
{
    ...
    public override void SendNotification()  //переопределение метода 
    {
        Console.WriteLine("Дорогие сотрудники компании....");
    }

    public override sealed string Address   //sealed - данный метод уже нельзя перегружать классам потомкам
    {
        get
        {
