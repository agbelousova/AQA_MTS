...
for (int i = 1; i < 6; i++)
{
    ...
    ProductHelper.AddProduct(ref productShop, item);
}
...
while (!exitFlag)
{
    ...
    switch (Console.ReadLine())
    {
        case "1":
        {
            ...
            ProductHelper.PrintProduct(productShop);
            break;
        }
        case "2":
        {
            ...
            ProductHelper.SearchByID(productShop, searchId);
            break;
        }
        case "3":
        {
            ...
            ProductHelper.UpdateProduct(ref productShop, updateId);
            ProductHelper.PrintProduct(productShop);
            break;
        }
        case "4":
        {
            ...
            ProductHelper.DeleteProduct(ref productShop, deletedId);
            ProductHelper.PrintProduct(productShop);
            break;
        }
        case "5":
